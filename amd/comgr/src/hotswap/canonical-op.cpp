...
#define S(N) case CanonicalOp::N: return #N;
  switch (Op) {
    ...
    // VOP1
    S(V_MOV_B32) S(V_MOV_B64) S(V_MOV_B16) S(V_NOP) S(V_ILLEGAL) S(V_NOT_B32) S(V_BFREV_B32)
    S(V_SWAP_B32)
    S(V_MOVRELS_B32) S(V_MOVRELD_B32)
    ...
    S(V_LDEXP_F32)
    S(V_FLOOR_F32) S(V_FLOOR_F64) S(V_CEIL_F32) S(V_CEIL_F64) S(V_TRUNC_F32) S(V_TRUNC_F64) S(V_RNDNE_F32) S(V_FRACT_F32)
    ...
    S(V_FMA_F16)
    S(V_MAX_F16) S(V_MIN_F16) S(V_MIN3_NUM_F16) S(V_MAX3_NUM_F16)
    ...
    S(V_CVT_F16_U16) S(V_CVT_U16_F16) S(V_CVT_F16_I16) S(V_CVT_I16_F16)
    ...
    S(V_RCP_F64) S(V_RSQ_F64) S(V_SQRT_F64)
    S(V_FREXP_EXP_I32_F64) S(V_FREXP_MANT_F64)
    S(V_DIV_SCALE_F64) S(V_DIV_FMAS_F64) S(V_DIV_FIXUP_F64)
    S(V_LDEXP_F64)
    ...
    S(V_PK_MAX_NUM_F16) S(V_PK_MIN_NUM_F16)
    S(V_PK_MIN3_NUM_F16) S(V_PK_MAX3_NUM_F16)
    ...
    S(DS_CMPSTORE_B32)
    S(DS_SWIZZLE_B32)
    S(DS_CMPSTORE_RTN_B32) S(DS_CMPSTORE_RTN_B64)
    S(DS_CMPSTORE_B32) S(DS_CMPSTORE_B64)
    // MUBUF
