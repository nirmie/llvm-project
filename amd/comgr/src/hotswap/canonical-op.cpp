...
#define S(N) case CanonicalOp::N: return #N;
  switch (Op) {
    ...
    S(V_PK_MIN_NUM_F16) S(V_PK_MAX_NUM_F16)
    S(V_PK_MIN3_NUM_F16) S(V_MIN3_NUM_F16)
    ...
    S(FLAT_ATOMIC_ADD_F32) S(FLAT_ATOMIC_ADD_F64)
    // GLOBAL atomics
    ...
    S(GLOBAL_ATOMIC_ADD_F32) S(GLOBAL_ATOMIC_ADD_F64)
