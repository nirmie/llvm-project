...
static const Entry kCanonTable[] = {
    ...
    // F32<->F64 converts are registered on `_e64` only.  The `_e32` forms
    // (e.g. V_CVT_I32_F64_e32_gfx12, decoded by the gfx1250 disassembler via
    // the shared gfx12 table) are canonicalized to `_e64` through the
    // getVOPe64 step in `canonicalize`, so a single `_e64` entry here covers
    // both encodings at runtime.
    ...
    E(SCRATCH_LOAD_DWORDX2_ST_gfx11, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX2_ST_gfx12, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX2_ST_gfx13, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX2_SADDR_gfx11, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX2_SADDR_gfx12, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX2_SADDR_gfx13, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX2_gfx11, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX2_gfx12, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX2_gfx13, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX2_SVS_gfx11, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX2_SVS_gfx12, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX2_SVS_gfx13, SCRATCH_LOAD_DWORDX2),
    E(SCRATCH_LOAD_DWORDX3_ST_gfx11, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX3_ST_gfx12, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX3_ST_gfx13, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX3_SADDR_gfx11, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX3_SADDR_gfx12, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX3_SADDR_gfx13, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX3_gfx11, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX3_gfx12, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX3_gfx13, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX3_SVS_gfx11, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX3_SVS_gfx12, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX3_SVS_gfx13, SCRATCH_LOAD_DWORDX3),
    E(SCRATCH_LOAD_DWORDX4_ST_gfx11, SCRATCH_LOAD_DWORDX4),
    E(SCRATCH_LOAD_DWORDX4_ST_gfx12, SCRATCH_LOAD_DWORDX4),
    E(SCRATCH_LOAD_DWORDX4_ST_gfx13, SCRATCH_LOAD_DWORDX4),
    E(SCRATCH_LOAD_DWORDX4_SADDR_gfx11, SCRATCH_LOAD_DWORDX4),
    E(SCRATCH_LOAD_DWORDX4_SADDR_gfx12, SCRATCH_LOAD_DWORDX4),
    E(SCRATCH_LOAD_DWORDX4_SADDR_gfx13, SCRATCH_LOAD_DWORDX4),
    E(SCRATCH_LOAD_DWORDX4_gfx11, SCRATCH_LOAD_DWORDX4),
    E(SCRATCH_LOAD_DWORDX4_gfx12, SCRATCH_LOAD_DWORDX4),
    E(SCRATCH_LOAD_DWORDX4_gfx13, SCRATCH_LOAD_DWORDX4),
    E(SCRATCH_LOAD_DWORDX4_SVS_gfx11, SCRATCH_LOAD_DWORDX4),
    E(SCRATCH_LOAD_DWORDX4_SVS_gfx12, SCRATCH_LOAD_DWORDX4),
    E(SCRATCH_LOAD_DWORDX4_SVS_gfx13, SCRATCH_LOAD_DWORDX4),
    ...
    E(SCRATCH_STORE_DWORDX2_ST_gfx11, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX2_ST_gfx12, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX2_ST_gfx13, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX2_SADDR_gfx11, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX2_SADDR_gfx12, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX2_SADDR_gfx13, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX2_gfx11, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX2_gfx12, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX2_gfx13, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX2_SVS_gfx11, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX2_SVS_gfx12, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX2_SVS_gfx13, SCRATCH_STORE_DWORDX2),
    E(SCRATCH_STORE_DWORDX3_ST_gfx11, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX3_ST_gfx12, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX3_ST_gfx13, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX3_SADDR_gfx11, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX3_SADDR_gfx12, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX3_SADDR_gfx13, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX3_gfx11, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX3_gfx12, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX3_gfx13, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX3_SVS_gfx11, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX3_SVS_gfx12, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX3_SVS_gfx13, SCRATCH_STORE_DWORDX3),
    E(SCRATCH_STORE_DWORDX4_ST_gfx11, SCRATCH_STORE_DWORDX4),
    E(SCRATCH_STORE_DWORDX4_ST_gfx12, SCRATCH_STORE_DWORDX4),
    E(SCRATCH_STORE_DWORDX4_ST_gfx13, SCRATCH_STORE_DWORDX4),
    E(SCRATCH_STORE_DWORDX4_SADDR_gfx11, SCRATCH_STORE_DWORDX4),
    E(SCRATCH_STORE_DWORDX4_SADDR_gfx12, SCRATCH_STORE_DWORDX4),
    E(SCRATCH_STORE_DWORDX4_SADDR_gfx13, SCRATCH_STORE_DWORDX4),
    E(SCRATCH_STORE_DWORDX4_gfx11, SCRATCH_STORE_DWORDX4),
    E(SCRATCH_STORE_DWORDX4_gfx12, SCRATCH_STORE_DWORDX4),
    E(SCRATCH_STORE_DWORDX4_gfx13, SCRATCH_STORE_DWORDX4),
    E(SCRATCH_STORE_DWORDX4_SVS_gfx11, SCRATCH_STORE_DWORDX4),
    E(SCRATCH_STORE_DWORDX4_SVS_gfx12, SCRATCH_STORE_DWORDX4),
    E(SCRATCH_STORE_DWORDX4_SVS_gfx13, SCRATCH_STORE_DWORDX4),
    ...
    // collapses DS_CMPSTORE_RTN_B32_gfx9 / _agpr and the gfx11/gfx12/gfx13
    // real forms onto DS_CMPSTORE_RTN_B32, and similarly for B64 and non-RTN.
    // The gfx12/gfx13 real opcodes are generated by DS_Real_gfx11_gfx12_gfx13
    // (DSInstructions.td:1551) and are what the gfx1250 disassembler emits;
    // without these entries the opcode-map lookup falls through to
    // UnsupportedOpcode (510 hits across 454 kernels in the corpus).
    E(DS_CMPSTORE_RTN_B32, DS_CMPSTORE_RTN_B32),
    E(DS_CMPSTORE_RTN_B32_gfx9, DS_CMPSTORE_RTN_B32),
    E(DS_CMPSTORE_RTN_B32_gfx11, DS_CMPSTORE_RTN_B32),
    E(DS_CMPSTORE_RTN_B32_gfx12, DS_CMPSTORE_RTN_B32),
    E(DS_CMPSTORE_RTN_B32_gfx13, DS_CMPSTORE_RTN_B32),
    E(DS_CMPSTORE_RTN_B64, DS_CMPSTORE_RTN_B64),
    E(DS_CMPSTORE_RTN_B64_gfx9, DS_CMPSTORE_RTN_B64),
    E(DS_CMPSTORE_RTN_B64_gfx11, DS_CMPSTORE_RTN_B64),
    E(DS_CMPSTORE_RTN_B64_gfx12, DS_CMPSTORE_RTN_B64),
    E(DS_CMPSTORE_RTN_B64_gfx13, DS_CMPSTORE_RTN_B64),
    E(DS_CMPSTORE_B32, DS_CMPSTORE_B32),
    E(DS_CMPSTORE_B32_gfx9, DS_CMPSTORE_B32),
    E(DS_CMPSTORE_B32_gfx11, DS_CMPSTORE_B32),
    E(DS_CMPSTORE_B32_gfx12, DS_CMPSTORE_B32),
    E(DS_CMPSTORE_B32_gfx13, DS_CMPSTORE_B32),
    E(DS_CMPSTORE_B64, DS_CMPSTORE_B64),
    E(DS_CMPSTORE_B64_gfx9, DS_CMPSTORE_B64),
    E(DS_CMPSTORE_B64_gfx11, DS_CMPSTORE_B64),
    E(DS_CMPSTORE_B64_gfx12, DS_CMPSTORE_B64),
    E(DS_CMPSTORE_B64_gfx13, DS_CMPSTORE_B64),
