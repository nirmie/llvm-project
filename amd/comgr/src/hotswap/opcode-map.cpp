...
static const Entry kCanonTable[] = {
    ...
    // real forms onto DS_CMPSTORE_RTN_B32, and similarly for the B64 and
    // non-RTN forms. The gfx12/gfx13 real opcodes are generated by the
    // DS_Real_gfx11_gfx12_gfx13 multiclass (DSInstructions.td:1551) and are
    // what the gfx1250 disassembler emits; without these entries the
    // opcode-map lookup falls through to UnsupportedOpcode.
