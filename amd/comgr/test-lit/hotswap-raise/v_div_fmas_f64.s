...
; RUN:     --emit-ir=v_div_fmas_f64_kernel 2>/dev/null \
; RUN:   | %FileCheck %s
;
; v_div_fmas_f64: VOP3 FP64 divide fused-multiply-add-scale -> llvm.amdgcn.div.fmas.f64

; CHECK-LABEL: define amdgpu_kernel void @v_div_fmas_f64_kernel(
; CHECK: call double @llvm.amdgcn.div.fmas.f64(double
