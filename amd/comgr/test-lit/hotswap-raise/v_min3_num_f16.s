...
; RUN:     --emit-ir=v_min3_num_f16_kernel 2>/dev/null \
; RUN:   | %FileCheck %s
;
; v_min3_num_f16: gfx12/gfx13 VOP3 scalar 3-input f16 min
; -> minnum(minnum(a, b), c) on half

; CHECK-LABEL: define amdgpu_kernel void @v_min3_num_f16_kernel(
