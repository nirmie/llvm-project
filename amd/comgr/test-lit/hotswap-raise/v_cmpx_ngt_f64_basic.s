...
;
; Pins Bug-Id 2026-05-26T09-18-05Z_qwen2.5-7b-instruct-018:
; Same 4 rocBLAS lange_one_columns kernels (fatbin_co_0116.co) re-filed as
; UnsupportedOpcode on v_cmpx_ngt_f64 (4 hits, 4 kernels) at hotswap commit
...
; 8f2db5ec2edc. All 64 kernels raise OK confirming the fix remains effective.
;
; Pins Bug-Id 2026-05-26T11-20-19Z_qwen2.5-7b-instruct-018:
; Same 4 rocBLAS lange_one_columns kernels (fatbin_co_0116.co) re-filed as
; UnsupportedOpcode on v_cmpx_ngt_f64 (4 hits, 4 kernels) at hotswap commit
; 8f2db5ec2edc. All 64 kernels raise OK confirming the fix remains effective.
;
; Pins Bug-Id 2026-05-26T12-18-34Z_qwen2.5-7b-instruct-018:
; Same 4 rocBLAS lange_one_columns kernels (fatbin_co_0116.co) re-filed as
; UnsupportedOpcode on v_cmpx_ngt_f64 (4 hits, 4 kernels) at hotswap commit
; 8f2db5ec2edc. All 64 kernels raise OK confirming the fix remains effective.
;
; Pins Bug-Id 2026-05-26T13-18-35Z_qwen2.5-7b-instruct-018:
; Same 4 rocBLAS lange_one_columns kernels (fatbin_co_0116.co) re-filed as
; UnsupportedOpcode on v_cmpx_ngt_f64 (4 hits, 4 kernels) at hotswap commit
; 8f2db5ec2edc. All 64 kernels raise OK confirming the fix remains effective.
;
; Pins Bug-Id 2026-05-26T14-14-07Z_qwen2.5-7b-instruct-018:
; Same 4 rocBLAS lange_one_columns kernels (fatbin_co_0116.co) re-filed as
; UnsupportedOpcode on v_cmpx_ngt_f64 (4 hits, 4 kernels) at hotswap commit
; 8f2db5ec2edc. All 64 kernels raise OK confirming the fix remains effective.
;
