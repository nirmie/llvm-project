...
; RUN:     --emit-ir=v_div_fixup_f64_kernel 2>/dev/null \
; RUN:   | %FileCheck %s
;
; v_div_fixup_f64: VOP3 FP64 divide fixup -> llvm.amdgcn.div.fixup.f64

; CHECK-LABEL: define amdgpu_kernel void @v_div_fixup_f64_kernel(
; CHECK: call double @llvm.amdgcn.div.fixup.f64(double
