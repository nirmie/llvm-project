...
;
; Bug-Id: 2026-05-26T14-14-07Z_qwen2.5-7b-instruct-017
;
; v_cmpx_ngt_f32 was reported as UnsupportedOpcode in 2 kernels of a
; rocBLAS trsv workload (rocblas_complex_num<float>) on gfx1250. The
; instruction belongs to the V_CMPX VOPC family; NGT ("not greater-than")
; maps to the LLVM FCmp predicate FCMP_ULE (unordered-or-less-than-or-equal).
;
; This test verifies that:
;   1. v_cmpx_ngt_f32_e32 is recognized and lowered to fcmp ule float
...
v_cmpx_ngt_f32_basic_kernel:
	...
	s_wait_loadcnt 0x0
	; v_cmpx_ngt_f32_e32: compare v0 vs v1, update EXEC.
