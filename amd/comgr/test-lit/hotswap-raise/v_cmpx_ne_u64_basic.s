...
;
; Pins Bug-Id 2026-05-26T12-18-34Z_qwen2.5-7b-instruct-016:
; Same 20 rocBLAS iamax/iamin kernels (fatbin_co_0059.co) re-filed a sixth
; time as UnsupportedOpcode on v_cmpx_ne_u64 (20 hits, 20 kernels). The
; handler remains effective via parseVCmpPseudoName() -> CanonicalOp::V_CMPX;
; all 20 kernels raise OK (20/20) confirming no regression.
;
; Pins Bug-Id 2026-05-26T13-18-35Z_qwen2.5-7b-instruct-016:
; Same 20 rocBLAS iamax/iamin kernels (fatbin_co_0059.co) re-filed a seventh
; time as UnsupportedOpcode on v_cmpx_ne_u64 (20 hits, 20 kernels). The
; handler remains effective via parseVCmpPseudoName() -> CanonicalOp::V_CMPX;
; all 20 kernels raise OK (20/20) confirming no regression.
;
; Pins Bug-Id 2026-05-26T14-14-07Z_qwen2.5-7b-instruct-016:
; Same 20 rocBLAS iamax/iamin kernels (fatbin_co_0059.co) re-filed an eighth
; time as UnsupportedOpcode on v_cmpx_ne_u64 (20 hits, 20 kernels). The
; handler remains effective via parseVCmpPseudoName() -> CanonicalOp::V_CMPX;
; all 20 kernels raise OK (20/20) confirming no regression.
;
; Pins Bug-Id 2026-05-26T15-20-57Z_qwen2.5-7b-instruct-016:
; Same 20 rocBLAS iamax/iamin kernels (fatbin_co_0059.co) re-filed a ninth
; time as UnsupportedOpcode on v_cmpx_ne_u64 (20 hits, 20 kernels). The
; handler remains effective via parseVCmpPseudoName() -> CanonicalOp::V_CMPX;
; all 20 kernels raise OK (20/20) confirming no regression.
