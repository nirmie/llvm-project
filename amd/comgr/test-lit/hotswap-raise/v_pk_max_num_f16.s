...
;
; Pins Bug-Id 2026-05-26T09-18-05Z_qwen2.5-7b-instruct-031:
; Same UnsupportedOpcode on v_pk_max_num_f16 [VOP3P], 48 hits across 48 rocBLAS
; geam_min_plus_kernel kernels (fatbin_co_0034.co) at hotswap commit
; 8f2db5ec2edc.  The V_PK_MAX_NUM_F16 handler was already in place;
; all 306 kernels in fatbin_co_0034.co raise OK (306 ok, 0 fail).
;
; Pins Bug-Id 2026-05-26T10-21-53Z_qwen2.5-7b-instruct-031:
; Same UnsupportedOpcode on v_pk_max_num_f16 [VOP3P], 48 hits across 48 rocBLAS
; geam_min_plus_kernel kernels (fatbin_co_0034.co) at hotswap commit
; 8f2db5ec2edc.  The V_PK_MAX_NUM_F16 handler was already in place;
; all 306 kernels in fatbin_co_0034.co raise OK (306 ok, 0 fail).
;
; Pins Bug-Id 2026-05-26T11-20-19Z_qwen2.5-7b-instruct-031:
; Same UnsupportedOpcode on v_pk_max_num_f16 [VOP3P], 48 hits across 48 rocBLAS
; geam_min_plus_kernel kernels (fatbin_co_0034.co) at hotswap commit
; 8f2db5ec2edc.  The V_PK_MAX_NUM_F16 handler was already in place;
; all 306 kernels in fatbin_co_0034.co raise OK (306 ok, 0 fail).
;
; Pins Bug-Id 2026-05-26T12-18-34Z_qwen2.5-7b-instruct-031:
; Same UnsupportedOpcode on v_pk_max_num_f16 [VOP3P], 48 hits across 48 rocBLAS
; geam_min_plus_kernel kernels (fatbin_co_0034.co) at hotswap commit
; 8f2db5ec2edc.  The V_PK_MAX_NUM_F16 handler was already in place;
; all 306 kernels in fatbin_co_0034.co raise OK (306 ok, 0 fail).
...
; all 306 kernels in fatbin_co_0034.co raise OK (306 ok, 0 fail).
;
; Pins Bug-Id 2026-05-26T14-14-07Z_qwen2.5-7b-instruct-031:
; Same UnsupportedOpcode on v_pk_max_num_f16 [VOP3P], 48 hits across 48 rocBLAS
; geam_min_plus_kernel kernels (fatbin_co_0034.co) at hotswap commit
; 8f2db5ec2edc.  The V_PK_MAX_NUM_F16 handler was already in place;
; all 306 kernels in fatbin_co_0034.co raise OK (306 ok, 0 fail).
