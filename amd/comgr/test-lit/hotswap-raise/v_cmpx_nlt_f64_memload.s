...
; RUN:     --emit-ir=v_cmpx_nlt_f64_memload_kernel 2>/dev/null \
; RUN:   | %FileCheck %s
;
; Regression test for false-positive CmpxFromLaneId on v_cmpx_nlt_f64 when
...
; v_cmpx_nlt_f64 sourcing v5 was falsely flagged.
;
...
;   3. v_cmpx_nlt_f64 sources v[4:5] (should NOT be flagged as CmpxFromLaneId)
;
; CHECK-LABEL: define amdgpu_kernel void @v_cmpx_nlt_f64_memload_kernel(

	.amdgcn_target "amdgcn-amd-amdhsa--gfx1250"
	.amdhsa_code_object_version 6
	.text
	.globl	v_cmpx_nlt_f64_memload_kernel
	.p2align	8
	.type	v_cmpx_nlt_f64_memload_kernel,@function
v_cmpx_nlt_f64_memload_kernel:
	...
	s_wait_loadcnt 0x0
	; Step 3: v_cmpx_nlt_f64 sources v[4:5] -- should NOT be CmpxFromLaneId
	...
	.p2align	6, 0x0
	.amdhsa_kernel v_cmpx_nlt_f64_memload_kernel
...
amdhsa.kernels:
  - .args:
    ...
    .name:           v_cmpx_nlt_f64_memload_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     2
    .symbol:         v_cmpx_nlt_f64_memload_kernel.kd
    .vgpr_count:     6
    .wavefront_size: 32
amdhsa.version: [1, 2]
...
