...
; raise OK with the current binary.
;
; Pins Bug-Id 2026-05-26T10-21-53Z_qwen2.5-7b-instruct-025:
; UnsupportedOpcode on v_frexp_exp_i32_f64 [VOP1], 109 hits across 9
; rocSOLVER stedcj_solve kernels in fatbin_co_0141.co at hotswap commit
; 8f2db5ec2edc. Already fixed by the frexp_mant/frexp_exp handlers; all
; 33 kernels in fatbin_co_0141.co raise OK with the current binary.
;
; Pins Bug-Id 2026-05-26T10-21-53Z_qwen2.5-7b-instruct-026:
; Same UnsupportedOpcode on v_frexp_mant_f64 [VOP1], 20 hits across 1
; rocSOLVER stebz_bisection_kernel (double-precision) in fatbin_co_0135.co
; at hotswap commit 8f2db5ec2edc. Already fixed by the frexp_mant/frexp_exp
; handlers; all 21 kernels in fatbin_co_0135.co raise OK with the current
; binary.
;
; Pins Bug-Id 2026-05-26T11-20-19Z_qwen2.5-7b-instruct-026:
; Same UnsupportedOpcode on v_frexp_mant_f64 [VOP1], 20 hits across 1
; rocSOLVER stebz_bisection_kernel (double-precision) in fatbin_co_0135.co
; at hotswap commit 8f2db5ec2edc. Already fixed by the frexp_mant/frexp_exp
; handlers; all 21 kernels in fatbin_co_0135.co raise OK with the current
; binary.
;
; Pins Bug-Id 2026-05-26T13-18-35Z_qwen2.5-7b-instruct-026:
; Same UnsupportedOpcode on v_frexp_mant_f64 [VOP1], 20 hits across 1
; rocSOLVER stebz_bisection_kernel (double-precision) in fatbin_co_0135.co
; at hotswap commit 8f2db5ec2edc. Already fixed by the frexp_mant/frexp_exp
; handlers; all 21 kernels in fatbin_co_0135.co raise OK with the current
; binary.
;
; Pins Bug-Id 2026-05-26T14-14-07Z_qwen2.5-7b-instruct-026:
; Same UnsupportedOpcode on v_frexp_mant_f64 [VOP1], 20 hits across 1
; rocSOLVER stebz_bisection_kernel (double-precision) in fatbin_co_0135.co
; at hotswap commit 8f2db5ec2edc. Already fixed by the frexp_mant/frexp_exp
; handlers; all 21 kernels in fatbin_co_0135.co raise OK with the current
