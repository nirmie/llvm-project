...
; RUN:     --emit-ir=v_frexp_mant_f64_kernel 2>/dev/null \
; RUN:   | %FileCheck %s
;
; v_frexp_mant_f64: VOP1 FP64 frexp mantissa -> llvm.amdgcn.frexp.mant.f64
...
v_frexp_mant_f64_kernel:
	...
	v_mov_b32_e32 v3, 0
	;;#ASMSTART
	v_frexp_mant_f64_e32 v[0:1], v[0:1]
	;;#ASMEND
	global_store_b64 v3, v[0:1], s[2:3] scale_offset
	s_endpgm
