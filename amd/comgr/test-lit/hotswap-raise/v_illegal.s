...
;
; Pins Bug-Id 2026-05-26T10-21-53Z_qwen2.5-7b-instruct-027:
; 71-hit / 71-kernel rocprim scan workload (fatbin_co_0298.co) re-filed as
; UnsupportedOpcode on v_illegal at hotswap commit 8f2db5ec2edc. Same root
; cause and same fix; all 93 kernels raise OK against --target-isa=gfx950.
;
; Pins Bug-Id 2026-05-26T11-20-19Z_qwen2.5-7b-instruct-027:
; 71-hit / 71-kernel rocprim scan workload (fatbin_co_0298.co) re-filed as
; UnsupportedOpcode on v_illegal at hotswap commit 8f2db5ec2edc. Same root
; cause and same fix; all kernels raise OK against --target-isa=gfx950.
;
; Pins Bug-Id 2026-05-26T12-18-34Z_qwen2.5-7b-instruct-027:
; 71-hit / 71-kernel rocprim scan workload (fatbin_co_0298.co) re-filed as
; UnsupportedOpcode on v_illegal at hotswap commit 8f2db5ec2edc. Same root
; cause and same fix; all kernels raise OK against --target-isa=gfx950.
;
; Pins Bug-Id 2026-05-26T13-18-35Z_qwen2.5-7b-instruct-027:
; 71-hit / 71-kernel rocprim scan workload (fatbin_co_0298.co) re-filed as
; UnsupportedOpcode on v_illegal at hotswap commit 8f2db5ec2edc. Same root
; cause and same fix; all 93 kernels raise OK against --target-isa=gfx950.
